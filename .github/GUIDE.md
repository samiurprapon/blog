...
```
git clone https://github.com/this-is-you/blog.git
```

where `this-is-you` is your GitHub username. Here you're copying the contents of the blog repository on GitHub to your computer.
